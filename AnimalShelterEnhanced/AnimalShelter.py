...
class AnimalShelter:
    ...
    def __init__(
        ...
        # Initialize MongoDB connection using environment variables or defaults.
        ...
        try:
            ...
            # Ensure that usernames are unique in the users collection.
            self.database['users'].create_index('username', unique=True)
            # Test connection to MongoDB.
            self.client.admin.command('ping')
        except errors.PyMongoError as e:
            # Handle connection errors and raise an exception with a message.
    ...
    def register_user(self, username: str, password: str) -> tuple:
        ...
        try:
            ...
            # Attempt to insert the new user; will fail if username already exists.
