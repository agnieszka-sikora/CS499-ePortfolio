...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("directionalLight.direction", 1.0f, 1.0f, 7.0f);
	...
	m_pShaderManager->setVec3Value("directionalLight.specular", 1.0f, 1.0f, 0.0f);
	m_pShaderManager->setFloatValue("directionalLight.focal", 64.0f);
	m_pShaderManager->setFloatValue("directionalLight.specularIntensity", 2.5f);
	m_pShaderManager->setBoolValue("directionalLight.bActive", true);

	// point light 1
	m_pShaderManager->setVec3Value("pointLights[0].position", 3.0f, 5.0f, 3.0f);
	...
	m_pShaderManager->setVec3Value("pointLights[0].specular", 0.0f, 0.1f, 0.0f);
	m_pShaderManager->setFloatValue("pointLights[0].focal", 10.0f);
	m_pShaderManager->setFloatValue("pointLights[0].specularIntensity", 5.0f);
	m_pShaderManager->setBoolValue("pointLights[0].bActive", true);

	// point light 2
	m_pShaderManager->setVec3Value("pointLights[1].position", -3.0f, 5.0f, 5.0f);
	...
	m_pShaderManager->setVec3Value("pointLights[1].specular", 0.5f, 0.5f, 0.5f);
	m_pShaderManager->setFloatValue("pointLights[1].focal", 24.0f);
	m_pShaderManager->setFloatValue("pointLights[1].specularIntensity", 1.8f);
	m_pShaderManager->setBoolValue("pointLights[1].bActive", true);
	// point light 3
	m_pShaderManager->setVec3Value("pointLights[2].position", 9.0f, -8.5f, -5.0f);
	m_pShaderManager->setVec3Value("pointLights[2].ambient", 0.3f, 0.3f, 0.3f);
	m_pShaderManager->setVec3Value("pointLights[2].diffuse", 0.3f, 0.3f, 0.3f);
	m_pShaderManager->setVec3Value("pointLights[2].specular", 0.5f, 0.5f, 0.8f);
	m_pShaderManager->setFloatValue("pointLights[2].focal", 12.0f);
